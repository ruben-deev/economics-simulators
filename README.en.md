...
[delivery](https://ruben-deev.github.io/economics-simulators/games/foodtech/dist/novoeda-delivery-simulator-v1.23.5.html) ·
...
goes into the built file name (`…-simulator-v1.23.5.html`), into the page itself and into
