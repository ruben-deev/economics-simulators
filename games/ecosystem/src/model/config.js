...
export const LEVERS = [
  ...
  },
  {
    ...
    tip: {
      ru: 'Каждая новая вертикаль размывает фокус менеджмента — исполнение проседает во ВСЕХ сервисах сразу. Управляющая компания выкупает большую часть штрафа, но не весь: у денег здесь насыщение, ещё четверть остатка снимает сооснователь. Пока вертикаль одна, команда почти не нужна. И это не бесплатное лекарство: деньги на управление конкурируют с бюджетами самих сервисов и с запасом кассы. По замеру оптимум умеренный — при двух сервисах около 6–8 млн, при трёх около 4–6, а выше одиннадцати итог падает: за штраф вы платите больше, чем он стоит.',
