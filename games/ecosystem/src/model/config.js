...
export const START_ASSETS = [
  ...
  },
  {
    ...
    // Уровень сложности помогает активам неодинаково, и это замерено
    // (24 кода, одна политика): лёгкий поднимает этот старт в 1.07 раза,
    // сложный опускает в 0.99. Планка вердикта двигается вместе с ним —
    // иначе на лёгком «отлично» доставалось бы одному старту втрое чаще.
    gradeLevel: { easy: 1.07, hard: 0.99 },
