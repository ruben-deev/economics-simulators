...
export function focusPenalty(state, decisions) {
  ...
  // Сооснователь тянет управленческую нагрузку объёмом в целую вертикаль:
  // штраф считается так, будто их на одну меньше. Конкретной вертикали он не
  // забирает — штраф симметричен, это налог на внимание менеджмента, а не на
  // сервис. Это слот, а не доля штрафа — и в этом весь смысл правки.
