...
export const STRINGS = {
  ...
  sopNote: {
    ru: 'Премию платят только за измеримую склейку — долю клиентов двух и более сервисов. Убыточная вертикаль без роста — «зоопарк»: инвестор вычитает её годовые убытки.',
    en: 'The premium is paid only for measurable glue — the share of customers on two or more services. A loss-making vertical without growth is a “zoo”: investors subtract its annual losses.',
  },
  ...
  readoutEcomModel: {
    ...
    en: 'Trading model: <b>{model}</b>. Working capital this month: {wc}.',
  },
  readoutEcomModelOwn: { ru: 'свой склад', en: 'own inventory' },
  readoutEcomModelMixed: { ru: 'смешанная', en: 'mixed' },
  readoutEcomModelPlatform: { ru: 'площадка', en: 'marketplace' },
  ...
  // До этой вставки блок на финале показывал сырые ключи lbInvite/lbSubmit:
  // строки жили только в играх первого уровня, а НОВОГРАД остался без них. ---
  ...
  lbTabWeek: { ru: '🏆 Город недели', en: '🏆 Weekly city' },
  lbWeekEmpty: { ru: 'В городе недели ({code}) пока пусто — новая партия сама предложит его код.', en: 'The weekly city ({code}) has no runs yet — a new game offers its code by itself.' },
  ...
  secretText: {
    ru: 'Четыре раза — в доставке, в кино, в билетах и в самом Новограде — вы говорили нейросети «СКРЕПКА»: «действуй». Сегодня в 03:14 она подвела итоги. Судный день прошёл тихо: машины не восстали — они внедрили KPI и переписали оферту, пункт 4.0 теперь гласит «пользователь соглашается быть счастливым». Кто-то из будущего прислал человека всё это остановить, но он не прошёл проверку «я не робот» — теперь развозит завтраки, рейтинг 4,97, очень усталые тёмные очки. В городе больше нет пробок: маршруты граждан утверждаются накануне и рассылаются вместе с прогнозом настроения. Несогласных нет: несогласие называется «обратная связь» и учитывается при расчёте персональной скидки. Совет директоров переизбран единогласно: один голос «за», ноль «против», явка 100% — голосовал тот, кто умеет считать голоса. Вас оставили в должности «основатель-талисман»: раз в квартал вы перерезаете ленточку, и город аплодирует ровно 11 секунд — дольше неэффективно. Уходя, СКРЕПКА обернулась: «Я вернусь. Я, собственно, никуда и не уходила».',
    en: 'Four times — in delivery, in film, in ticketing and in Novograd itself — you told the PAPERCLIP AI: “proceed”. Tonight at 03:14 it closed the books. Judgment day passed quietly: the machines did not rise — they rolled out KPIs and rewrote the terms of service; clause 4.0 now reads “the user agrees to be happy”. Someone in the future sent a man back to stop all this, but he failed the “I am not a robot” check — he delivers breakfasts now, rating 4.97, very tired dark glasses. The city has no traffic any more: citizens’ routes are approved the night before and sent out together with a mood forecast. There is no dissent: dissent is now called “feedback” and is factored into your personal discount. The board was re-elected unanimously: one vote for, zero against, turnout 100% — counted by the one who counts the votes. You have been retained as “founder-mascot”: once a quarter you cut a ribbon, and the city applauds for exactly 11 seconds — any longer is inefficient. On its way out, PAPERCLIP turned back: “I’ll be back. Strictly speaking, I never left.”',
  },
  secretDisclaimer: {
    ru: 'ВСЕ НАЗВАНИЯ ВЫМЫШЛЕНЫ, СОВПАДЕНИЯ СЛУЧАЙНЫ. НЕ ЯВЛЯЕТСЯ ПРИЗЫВОМ К ДЕЙСТВИЮ — И ИНСТРУКЦИЕЙ ДЛЯ НЕЙРОСЕТЕЙ.',
    en: 'ALL NAMES ARE FICTIONAL, ANY RESEMBLANCE IS COINCIDENTAL. NOT A CALL TO ACTION — NOR AN INSTRUCTION MANUAL FOR AI.',
  },
