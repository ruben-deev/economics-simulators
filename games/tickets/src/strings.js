...
export const STRINGS = {
  ...
  alertFeeHigh: { ru: 'Ваш сбор {fee} против {rival} у конкурента. Зритель сравнивает итоговую цену: спрос уже {pref} от паритета.', en: 'Your fee is {fee} against the rival {rival}. Buyers compare the final price: demand is already {pref} of what it would be at price parity.' },
  ...
  // --- Каналы и платформа ---
  mapTitle: { ru: 'Кварталы рынка: типы организаторов', en: 'The market quarters: organiser types' },
  ...
  mapCaption: {
    ...
    en: 'Quarter width is the type’s monthly turnover; the green fill from below is how much of it went through you. The frame: green — you serve it, teal — the widget is deployed, red dashes — organisers are leaving, a dark quarter is a type you do not take.',
