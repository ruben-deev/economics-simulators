...
export const ANCHORS = {
  ...
  // Без сервисного сбора: дифференциация на витрине, всё своё берём с
  // организатора. Опора добавлена вместе с кнопкой «Без сбора» (игровой
  // отзыв 2026-08): стратегия стала доступной, и коридор должен её сторожить.
  'без сервисного сбора': {
    buyerFee: 0, orgCommission: 0.13, marketing: 30e6, managers: 35,
    onboarding: 0, platform: [], product: 12e6, support: 10e6, capacityTech: 6e6,
  },
