...
export const STRINGS = {
  ...
  cfoSharing: { ru: 'Доля общих паролей', en: 'Shared-password share' },
  cfoSharingNote: { ru: 'Эти люди смотрят каталог и стоят трафика, но не платят. Рычаг «доступ вне дома» решает, когда закрывать бесплатную витрину.', en: 'These people watch the catalogue and cost you bandwidth but pay nothing. The out-of-home access lever decides when to close the free shop window.' },
