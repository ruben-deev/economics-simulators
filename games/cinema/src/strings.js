...
export const STRINGS = {
  ...
  cfoYoungNote: { ru: 'Подписчики моложе трёх месяцев уходят по {young} в месяц, выдержанная база — по {mature}. Чем быстрее вы растёте, тем выше средний отток. И держит их разное: новичка — шум премьеры, ветерана — глубина полки; разрыв между ними свой у каждого сегмента.', en: 'Subscribers younger than three months churn at {young} a month, the mature base at {mature}. The faster you grow, the higher your average churn. And they stay for different reasons: the newcomer for the noise of a premiere, the veteran for the depth of the shelf — and the gap between them differs by segment.' },
