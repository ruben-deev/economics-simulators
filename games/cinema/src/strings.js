...
export const STRINGS = {
  ...
  plexNet: { ru: 'переток {n}', en: 'net switch {n}' },
  ...
  plexCaption: {
    ...
    en: 'Hall area is the base to scale: your two tiers with the rival beside them. Green arrows are this month’s inflow per tier, red is churn, the gold dashes are viewers trading down from premium over price, and the arrow between halls is market switching.',
  },
  ...
  partnerSignDetail: { ru: 'До {subs} новых в месяц по {arpu} вместо {retail}. Быстрый объём вместо выручки с человека.', en: 'Up to {subs} new a month at {arpu} instead of {retail}. Volume instead of revenue per head.' },
...
score = valuation × your stake`,
  ...
  debriefLicenseStall: {
    ...
    en: 'Catalogue licensing sat at zero for {n} months. The very same run makes $141M with 300M/month of licensing and $4M with none: the shelf melts faster than the savings add up.',
  },
  debriefPricyPremium: {
    ...
    en: 'Premium stayed at $4.49 or higher for {n} months — more than half the run. A $3.99 price beats $4.49 by about $7M: a pricey door cuts the inflow of newcomers before the revenue per subscriber catches up.',
  },
  debriefSummerAds: {
  ...
  metaReturnNone: {
    ...
    en: 'In NOVOGRAD this game’s finale becomes the holding’s starting asset: the base, ARPU and treasury there are what you earn here. You have no finished finales here yet — the first legacy step opens at {target}. It does not affect this game: the legacy works in NOVOGRAD, not here.',
  },
  metaReturnMaxed: {
