...
export const STRINGS = {
  ...
  cfoProjectsTitle: { ru: 'Что стоил каждый проект', en: 'What each project cost' },
  cfoReleasedIn: { ru: 'вышел в {month}-й месяц', en: 'released in month {month}' },
  cfoPerHour: { ru: '{value} за час', en: '{value} per hour' },
  cfoProjectsNote: { ru: 'Производство плюс кампания, поделённые на часы. Сравнивать надо не с ценой лицензионного часа, а с тем, сколько эти часы держат базу: своё дороже и не тает.', en: 'Production plus campaign divided by hours. Compare it not with the price of a licensed hour but with how well those hours hold the base: your own costs more and does not melt away.' },
