...
export const STRINGS = {
  ...
  newsRivalSurge: { ru: '<b>Конкурент закрыл внеплановый раунд и объявляет ценовую войну до конца года.</b> Досидеть финал на автопилоте не получится.', en: '<b>The rival has closed an unscheduled round and has declared a price war through the end of the year.</b> You will not coast through the finale on autopilot.' },
