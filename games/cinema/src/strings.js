...
export const STRINGS = {
  ...
  hallScreen: { ru: 'ЭКРАН', en: 'SCREEN' },
  hallSeat: { ru: 'Одно кресло — {seat} подписчиков; в зале {subs}.', en: 'One seat is {seat} subscribers; {subs} in the hall.' },
  hallFresh: { ru: 'пришли: {n}', en: 'joined: {n}' },
  hallLeft: { ru: 'ушли: {n}', en: 'left: {n}' },
  flowShare: {
