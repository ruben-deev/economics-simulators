  ...
  // --- События с выбором ---
  {
    ...
    options: [
      ...
      },
      {
        ...
        secret: true,
        label: { ru: 'Заменить актёра — сгенерировать нейросетью «СКРЕПКА»', en: 'Recast the role — with an actor generated by PAPERCLIP' },
        detail: {
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        // священна), различие чисто сюжетное.
        secret: true,
        label: { ru: 'Отстоять цену (объясняет «СКРЕПКА»)', en: 'Hold the price (PAPERCLIP explains)' },
        detail: {
          ru: 'Инвесторы недовольны, оценка ниже. СКРЕПКА вежливо объяснила совету, что скидка — это кредит у собственной выручки: недоволен, но впечатлён.',
          en: 'Investors are unhappy and the valuation suffers. PAPERCLIP politely explained to the board that a discount is a loan taken from your own revenue: unhappy, but impressed.',
        },
