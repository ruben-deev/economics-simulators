...
export const STRINGS = {
  ...
  newsCouriersGood: { ru: 'Набор обгоняет отток — на линии становится просторнее.', en: 'Hiring beats churn — the road is getting less crowded.' },
...
score = valuation × your stake`,
  ...
  gradeScale: { ru: 'Шкала: «отлично» — итог от {a}, «крепкий бизнес» — от {b}, «выжили» — от {c}. Доведённые стратегии на этом рынке заканчивают партию с итогом свыше 10 млрд ₽ — выжить легко, выиграть нет.', en: 'The scale: "excellent" starts at {a}, "a solid business" at {b}, "survived" at {c}. Polished strategies finish this market above ₽10B — surviving is easy, winning is not.' },
  ...
  deathText: { ru: 'В кассе {cash}, за прошлую неделю сожгли {burn}. Таким темпом денег хватит примерно на {runway}. Раунд ещё можно поднять — но чем ближе касса к нулю, тем хуже условия. Это предупреждение показывается один раз.', en: 'The till holds {cash}; last week burned {burn}. At this pace the money lasts about {runway}. A round can still be raised — but the closer the till is to zero, the worse the terms. You will only see this warning once.' },
  ...
  seedNote: { ru: 'Одинаковый код — одинаковый город: погода, события и рынок совпадут у всех, кто его введёт. Оставьте пустым, чтобы получить случайный.', en: 'The same code means the same city: weather, events and market will match for everyone who enters it. Leave empty for a random one.' },
  ...
  fundingRunway: { ru: 'При темпе прошлой недели кассы хватит примерно на {n} нед. Раунд дешевле поднимать заранее, а не у нуля.', en: 'At last week’s pace the till lasts about {n} weeks. A round is cheaper raised early, not at zero.' },
  // --- Приветственный экран ---
  welcomeTitle: { ru: '🛵 Вы запускаете доставку еды', en: '🛵 You are launching a food delivery service' },
  welcomeRole: { ru: 'Город Новоград, сервис «НОВОЕДА»: приложение, несколько сотен ресторанов и курьеры на самокатах. Дальше всё решаете вы — сколько брать за доставку, сколько удерживать с ресторана, сколько платить курьеру, в какие районы идти и на что тратить деньги.', en: 'The city of Novograd and a service called NOVOEDA: an app, a few hundred restaurants and couriers on scooters. Everything after that is your call — what to charge for delivery, what to keep from the restaurant, what to pay a courier, which districts to enter and where the money goes.' },
  welcomeTurn: { ru: '<b>Один ход — неделя,</b> вся партия — год, 52 хода. Вы двигаете ползунки, жмёте «Сыграть неделю» и смотрите, что из этого вышло: сколько заказов, сколько денег, кто ушёл и почему.', en: '<b>One turn is a week,</b> and a whole game is a year — 52 turns. You move the sliders, press "Run week" and see what came of it: how many orders, how much money, who left and why.' },
  welcomeTension: { ru: '<b>В чём подвох.</b> Сейчас человек платит за доставку 149 ₽, а курьер за эту же поездку получает 180 ₽. Каждый заказ уходит в минус, и разницу нужно откуда-то добрать. Поднимете цену — закажут реже. Урежете курьерам — они уйдут, еда поедет дольше, и закажут реже уже из-за этого. Выход есть, но он не в одном ползунке.', en: '<b>Where the catch is.</b> Right now a customer pays ₽149 for delivery and the courier is paid ₽180 for that same trip. Every order loses money, and the gap has to come from somewhere. Raise the price and people order less. Cut courier pay and couriers leave, food arrives later, and people order less anyway. There is a way out, but it is not one slider.' },
  welcomeGoal: { ru: '<b>Проиграть здесь не страшно.</b> Это не про рекорд: разориться на третьем месяце и понять почему — полезнее, чем случайно выжить и не понять ничего.', en: '<b>Losing here is fine.</b> This is not about a high score: going broke in month three and understanding why teaches you more than surviving by accident.' },
  welcomeStart: { ru: 'Начать', en: 'Start' },
  welcomeMore: { ru: 'Как всё устроено', en: 'How it works' },
  welcomeHint: { ru: '<b>Первый ход.</b> Можно ничего не трогать и просто нажать «Сыграть неделю» — посмотреть, как всё работает. У каждого ползунка есть «зачем это?», а после хода игра сама разбирает результат по частям. Кнопка «?» в шапке — если захочется подробностей.', en: '<b>Your first turn.</b> You can change nothing and just press "Run week" to see how it all moves. Every slider has a "why does this matter?", and after each turn the game takes the result apart for you. The "?" button in the header has the rest.' },
