...
export const STRINGS = {
  ...
  weatherHabit: { ru: 'Курьеры привыкли к надбавке: её эффект в плохую погоду ослаблен на {loss}. Постоянная доплата становится частью зарплаты — выключайте её в ясные недели, чтобы в шторм она снова работала.', en: 'Couriers are used to the bonus: its bad-weather effect is weakened by {loss}. A permanent extra becomes part of the wage — switch it off in clear weeks so it works again in a storm.' },
  ...
  wxQuipStorm: { ru: 'Курьеры героически стоят под козырьком.', en: 'Couriers are heroically standing under an awning.' },
  ...
  newsSeasonSpring: { ru: '<b>Начинается весна.</b> Погода успокаивается, город выходит на улицу — заказывать станут ровнее и чуть реже.', en: '<b>Spring is starting.</b> The weather settles, the city goes outdoors — ordering gets steadier and a little rarer.' },
  ...
  newsCouriersEven: { ru: 'Сколько ушло, столько и вышло: команда стоит на месте — она держится ровно на той оплате, что вы назначили.', en: 'As many came on as left: the team is standing still — it holds exactly at the pay you set.' },
  ...
  newsCustomersEven: { ru: 'Пришло столько же, сколько ушло: база стоит на месте, а маркетинг за это уже заплачен.', en: 'As many came as left: the base is standing still, and the marketing for it is already paid.' },
...
score = valuation × your stake`,
  ...
  gradeScale: { ru: 'Шкала: «отлично» — итог от {a}, «крепкий бизнес» — от {b}, «выжили» — от {c}. Сильные игроки заканчивают партию с итогом 4.5–6.5 млрд ₽ — выжить легко, выиграть нет.', en: 'The scale: "excellent" starts at {a}, "a solid business" at {b}, "survived" at {c}. Strong players finish this market at $45–65M — surviving is easy, winning is not.' },
  ...
  debriefStorms: {
    ...
    en: '{n} storm weeks went unanswered — no courier bonus and no forecast auto-hiring. Players who answer the storms gain up to +87% on the final score.',
  },
  debriefAlgosIdle: {
  ...
  welcomeTension: { ru: '<b>В чём подвох.</b> Человек платит за доставку 149 ₽, а курьер за ту же поездку получает 180 ₽ — каждый заказ в минусе. Поднимете цену — закажут реже; урежете курьерам — уйдут, и еда поедет дольше. Выход есть, но не в одном ползунке.', en: '<b>Where the catch is.</b> A customer pays $1.49 for delivery while the courier gets $1.80 for the same trip — every order loses money. Raise the price and people order less; cut courier pay and couriers leave, so food arrives later. There is a way out, but it is not one slider.' },
