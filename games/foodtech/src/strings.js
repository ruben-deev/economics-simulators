...
score = valuation × your stake`,
  ...
  welcomeRole: { ru: 'Город Новоград, сервис «НОВОЕДА». Вы принимаете решения за всю компанию: сколько брать с клиента и с ресторана, сколько платить курьерам, в какие районы идти и на что тратить деньги.', en: 'The city of Novograd, a service called NOVOEDA. You decide for the whole company: what to charge the customer and the restaurant, what to pay couriers, which districts to enter and where the money goes.' },
  welcomeTurn: { ru: '<b>Ход — неделя.</b> Партия идёт год: 52 хода. Вы выставляете рычаги, нажимаете «Сыграть неделю» и читаете, что из этого вышло.', en: '<b>One turn is a week.</b> A game runs a year: 52 turns. You set the levers, press "Run week" and read what came of it.' },
  ...
  welcomeTension: { ru: '<b>Главная трудность.</b> Доставка — бизнес с отрицательной экономикой по умолчанию. Курьеры стоят денег, пока едут и пока стоят; скорость покупается людьми, а люди — маржой. Разориться здесь легко и понятно.', en: '<b>The hard part.</b> Delivery is a business with negative economics by default. Couriers cost money while riding and while idle; speed is bought with people, and people are bought with margin. Going broke here is easy and instructive.' },
