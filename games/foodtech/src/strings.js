...
export const STRINGS = {
  ...
  goalUnit: { ru: 'Вклад с заказа не ниже {target} при {floor} заказах в неделю. Оборот чужой, вклад ваш — и одним ростом эту цель не взять.', en: 'Contribution of at least {target} per order at {floor} orders a week. The GMV is someone else’s money, the contribution is yours — and growth alone will not get you there.' },
  ...
  unitPayment: { ru: 'Эквайринг', en: 'Card processing' },
...
score = valuation × your stake`,
  ...
  chartChangeDistricts: { ru: 'зоны покрытия', en: 'coverage areas' },
