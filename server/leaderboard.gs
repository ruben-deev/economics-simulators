...
//
// Суффикс «·сложный» — отдельный уровень сложности НОВОГРАДА: там финансовая
// команда стоит вчетверо дороже, поэтому результаты несопоставимы с обычным
// уровнем и ведутся своей таблицей. Лёгкий уровень не отправляется вовсе:
// бесплатная финансовая команда несравнима с купленной.
const GAMES = [
  'НОВОЕДА', 'КИНОРЕКА', 'БИЛЕТВИЛЬ',
  'НОВОГРАД', 'НОВОГРАД+',
  'НОВОГРАД·сложный', 'НОВОГРАД+·сложный',
];
const NAME_MAX = 24;
