...
//
// Суффикс уровня сложности — тоже отдельная таблица. Уровень набора меняет
// цену финансовой команды: партии, сыгранные при разной цене денег, между
// собой несравнимы. У обычного уровня суффикса нет — прежние рекорды
// остаются в своих таблицах.
const GAMES = [
  'НОВОЕДА', 'НОВОЕДА·лёгкий', 'НОВОЕДА·сложный',
  'КИНОРЕКА', 'КИНОРЕКА·лёгкий', 'КИНОРЕКА·сложный',
  'БИЛЕТВИЛЬ', 'БИЛЕТВИЛЬ·лёгкий', 'БИЛЕТВИЛЬ·сложный',
  'НОВОГРАД', 'НОВОГРАД·лёгкий', 'НОВОГРАД·сложный',
  'НОВОГРАД+', 'НОВОГРАД+·лёгкий', 'НОВОГРАД+·сложный',
];
const NAME_MAX = 24;
