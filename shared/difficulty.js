...
export const DIFFICULTIES = [
  ...
  },
  {
    ...
    tagSuffix: '',
    note: {
      ru: 'Финансовую команду нанимаете вы, и она недорогая: половина силы примерно за 3% выручки в месяц. Основной уровень: баланс игры рассчитан на него.',
      en: 'You hire the finance team yourself, and it is cheap: half its strength for roughly 3% of monthly revenue. The main level: the game’s balance is built around it.',
    },
  },
  {
    id: 'hard',
