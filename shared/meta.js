...
//
//   ЕДИНИЦЫ ПЕРЕНОСА ПРИВЯЗАНЫ К ВЕРДИКТАМ ИГР (аудит 2026-08). Правило
//   «solid — средняя опора» разъехалось с жизнью: опорные стратегии — это
//   измерительный инструмент, они нарочно простые и не равны «крепкой игре».
//   У НОВОЕДЫ это дало прямое противоречие на экранах: игра писала «крепкий
//   бизнес» уже с 2.2 млрд, а НОВОГРАД на том же результате — «до крепкого
//   финала не дотянуло», потому что единицей переноса стояли 5.5 млрд от
//   давно пересобранного баланса. Теперь единица переноса — тот самый порог
//   «крепко», который игрок видит в финале своей игры (VERDICT.solid в
//   конфиге каждой игры), и разъехаться им больше нельзя: сверяет тест.
//   НОВОЕДА 5.5 -> 2.2 млрд, КИНОРЕКА 5 -> 4.5, БИЛЕТВИЛЬ 4 -> без изменений.
//
...
export const LEGACY_GAMES = [
  { assetId: 'delivery', tag: 'НОВОЕДА', recordsKey: 'novoeda-records', threshold: 0.3e9, solid: 2.2e9 },
  { assetId: 'streaming', tag: 'КИНОРЕКА', recordsKey: 'kinoreka-records', threshold: 1.5e9, solid: 4.5e9 },
