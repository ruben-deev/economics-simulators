...
/**
 * Сброс пути серии: введённые строки наследия, лучший финал НОВОГРАДА и
 * незаконченные партии всех четырёх игр. Нужен, чтобы пройти путь заново
 * с чистого листа — например, показать группе игру «как в первый раз».
 * Раньше сейвы старых игр не трогались, и после сброса НОВОЕДА встречала
 * недоигранной партией с полными графиками — «заново» не ощущалось.
 *
