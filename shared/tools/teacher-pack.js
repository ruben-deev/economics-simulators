...
//
// Внутри архива всё, что нужно, чтобы принести игру на занятие: офлайн-сборка
// игры, заметки к занятию и разбор формул на двух языках, шаблон таблицы для
// сбора результатов и записка про первые пять минут. HTML документации
...
Что внутри / What is inside:
  ...
  docs/teacher-guide.html (RU) · docs/en/teacher-guide.html (EN)
      — заметки к занятию: где модель ведёт себя неожиданно.
        Class notes: where the model behaves unexpectedly.
