...
export const EVENTS = [
  {
    id: 'rain', weight: 10, minWeek: 2,
    title: 'Затяжные дожди',
    text: 'Неделю льёт. Люди не хотят выходить из дома — спрос на доставку подскочил, но курьеры едут медленнее и злее.',
    effects: { demandMult: 1.22, capacityMult: 0.88, courierChurnAdd: 0.02 },
    lesson: 'Пик спроса при падении пропускной способности — самый частый сценарий провала SLA.',
  },
  {
    id: 'heat', weight: 6, minWeek: 10,
    title: 'Аномальная жара',
    text: 'Курьеры на велосипедах выгорают быстрее обычного, часть смен сорвана.',
    effects: { capacityMult: 0.9, courierChurnAdd: 0.03 },
    lesson: 'Пропускная способность — это не число курьеров, а число курьеро-часов.',
  },
  {
